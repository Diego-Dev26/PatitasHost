...
const headers = [
  ...
  //endJSid_usuario
  //initJStipo_denuncia
  { name: "Tipo de Denuncia", field: "tipo_denuncia" },
  //endJStipo_denuncia
  //initJSestado
...
function Denuncia_list() {
  ...
  useEffect(() => {
    var temp = {};
    temp.read = store.checkPermissions(["read_denuncia"]);
    temp.report = store.checkPermissions(["report_denuncia"]);
    temp.update = store.checkPermissions(["update_denuncia"]);
    temp.delete = store.checkPermissions(["delete_denuncia"]);
      ...
      <div className="px-2  py-1 sm:py-2 xl:py-4 ">
        <div className="bg-gray-50 px-1  py-0.5 sm:py-0.5 2xl:py-1  sm:flex flex flex-wrap-reverse sm:items-center w-full">
          ...
          <div className="ml-6 sm:ml-0 flex-none">
            {store.checkPermissions(["create_denuncia"]) && (
              <Link
                to="../denuncia/create"
                type="button"
