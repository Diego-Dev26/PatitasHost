...
const headers = [
  ...
  //endJSid_mascota
  //initJSid_usuario
  { name: "Usuario", field: "id_usuario" },
  //endJSid_usuario
  //headers
];

function Adopcion_list() {
  ...
  useEffect(() => {
    var temp = {};
    temp.read = store.checkPermissions(["read_adopcion"]);
    temp.report = store.checkPermissions(["report_adopcion"]);
    temp.update = store.checkPermissions(["update_adopcion"]);
    temp.delete = store.checkPermissions(["delete_adopcion"]);
      ...
      <div className="px-2  py-1 sm:py-2 xl:py-4 ">
        <div className="bg-gray-50 px-1  py-0.5 sm:py-0.5 2xl:py-1  sm:flex flex flex-wrap-reverse sm:items-center w-full">
          ...
          <div className="ml-6 sm:ml-0 flex-none">
            {store.checkPermissions(["create_adopcion"]) && (
              <Link
                to="../adopcion/create"
                type="button"
                    ...
                    list.map((adopcion, index) => (
                      <tr key={index}>
                        ...
                        <td className="2xl:px-3 sm:px-2 px-1 2xl:py-4 sm:py-2 py-1 2xl:text-sm text-xs text-gray-500">
                          {adopcion?.id_mascota?.nombre}
                        </td>
                        {/* endJSXid_mascota */}
                        {/* initJSXid_usuario */}
                        <td className="2xl:px-3 sm:px-2 px-1 2xl:py-4 sm:py-2 py-1 2xl:text-sm text-xs text-gray-500">
                          {adopcion?.id_usuario?.name}
                        </td>
                        {/* endJSXid_usuario */}
